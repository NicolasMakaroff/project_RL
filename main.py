...
if __name__ == '__main__':
    ...
    Vpi_b = Optaflow.policy_evaluation(env.P,env.R, pi_b, gamma = env.gamma, eps_greedy = False) # V^pi_b
    ...
    opt_eps0, Vpi_opt_eps0 = Optaflow.policy_iteration_eps0(env.P, env.R, gamma = env.gamma, tol = 1e-5) 
